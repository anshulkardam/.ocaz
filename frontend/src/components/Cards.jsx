...
export const Cards = ({ item }) => {
    ...
    return <div className="pt-4">
        ...
        <div className="relative h-full flex " >
            <img src={item.img} className="object-cover h-[200px] w-[300px] rounded-md " />
            <div className="w-full">
                <div>
                    {item.title}
                </div>

                <div className="flex"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
